    ...
    async def open(
        ...
        **kwargs: Any,
        ...
        return BrowserResult(
            ...
            cookies=getattr(ret, "cookies", None) or [],
            cookie_header=getattr(ret, "cookie_header", "") or "",
            cf_clearance=getattr(ret, "cf_clearance", None),
            turnstile_token=getattr(ret, "turnstile_token", None),
